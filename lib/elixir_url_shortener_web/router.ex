defmodule ElixirUrlShortenerWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {ElixirUrlShortenerWeb.LayoutView, :root}
  ...
  scope "/", ElixirUrlShortenerWeb do
    ...
    get "/:shortened_url", PageController, :redirect_url
  end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: ElixirUrlShortenerWeb.Telemetry
    end
  end
